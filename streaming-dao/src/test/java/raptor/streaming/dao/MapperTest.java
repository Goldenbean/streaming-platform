...
public class MapperTest {
  ...
  public void selectAllTest() {
    ...
    JobFileEntity jobFileEntity = jobFileMapper.selectById(28L);
  ...
  @Test
  public void test(){
    List<FileSystemEntity> fileSystemEntities1 = fileSystemMapper.selectList(Wrappers.<FileSystemEntity>query());

    fileSystemEntities1.forEach(i-> System.out.println(i));
    List<FileSystemEntity> fileSystemEntities2 = fileSystemMapper.selectLogicDeleted();
