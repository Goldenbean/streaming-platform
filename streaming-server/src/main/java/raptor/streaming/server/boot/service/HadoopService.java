...
import raptor.streaming.server.boot.common.Utils;
...
public class HadoopService {
  ...
  private void init() throws Exception {
    ...
    List<ClusterPO> allCluster = clusterDao.getAllClusterByType(1);
  ...
  public void addCluster(ClusterPO cluster) throws IOException {
  ...
  private void updateClusterConfig(ClusterPO cluster, String clusterConfigDirPath) throws IOException {
    File clusterConfigDir = new File(clusterConfigDirPath);
    ...
    if (files.length > 0) {
      ...
      clusterDao.updateClusterConf(cluster.getName(), clusterConf.toJSONString());
    }

  }

  private String initClusterConfigDir(ClusterPO cluster) throws IOException {
  ...
  private Boolean downloadConfig(ClusterPO cluster, String downloadDir) throws IOException {
  ...
  public void removeHadoopClient(String clusterName) {
