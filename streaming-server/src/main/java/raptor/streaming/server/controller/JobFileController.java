...
public class JobFileController {
  ...
  public RestResult get(
    ...
    JobFileEntity jobFileEntity = jobFileService.getOne(new QueryWrapper<JobFileEntity>().lambda().eq(JobFileEntity::getFileId, fileId));
  ...
  public RestResult save( @RequestBody JobFileEntity jobFileEntity) {
    if(jobFileService.saveOrUpdate(jobFileEntity, Wrappers.<JobFileEntity>lambdaUpdate().eq(JobFileEntity::getFileId,jobFileEntity.getFileId()))){
